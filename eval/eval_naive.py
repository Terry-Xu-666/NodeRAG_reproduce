...
def Response(search_engine,questions,path):
    ...
    questions.to_parquet(path.replace('.parquet', 'naive_responsed.parquet'))
    return questions
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="Nconfig.yaml", type=str, help="the config file")
    ...
    search_engine = Naive_search(NaiveConfig(config))
